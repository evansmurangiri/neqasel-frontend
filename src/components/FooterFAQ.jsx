...
export function WAFloat() {
  return (
    <div style={{ position:'fixed',bottom:'1.25rem',right:'1.25rem',zIndex:500,width:52,height:52,background:'#10b981',borderRadius:'50%',display:'flex',alignItems:'center',justifyContent:'center',boxShadow:'0 4px 18px rgba(16,185,129,.35)',cursor:'pointer',transition:'all .2s' }}
      onMouseEnter={e=>{ e.currentTarget.style.background='#34d399'; e.currentTarget.style.transform='scale(1.07)'; }}
